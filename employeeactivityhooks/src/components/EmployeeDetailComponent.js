...
return(
  ...
  <div className="card-body">
    ...
    <div><input type="button" id={props.eid} style={styleObject.buttonStyle } className="btn btn-primary"  onClick={props.deleteEmp} value="Delete"/></div>
    <div><input type="button" id={props.eid} style={styleObject.buttonStyle } className="btn btn-primary"  onClick={props.updateEmp} value="Update"/></div>
  </div>
  </div>
)
